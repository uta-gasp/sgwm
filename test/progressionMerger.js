...
describe( 'ProgressionMerger', () => {
	...
	it( 'should make 2 lines out of 3 progressions', () =>  {
	...
	it( 'should make 3 lines out of few challenging progressions', () =>  {
	    ...
	    assert.isDefined( progressions[9].removed, 'progression.9 was not dropped' );
	    assert.isDefined( progressions[10].removed, 'progression.10 was not dropped' );
	});
